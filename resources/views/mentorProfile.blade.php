...
<body>
    ...
    <form action="" class="mx-36 mt-10 p-5 border rounded-xl flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-2">
            <label for="pengalaman" class="text-lg font-semibold">Pengalaman</label>
            <input type="text" value="" class="border rounded-lg p-2">
        </div>
        <div class="flex flex-col gap-2">
        ...
        <div class="flex flex-col gap-2">
            <label for="tahunpengalaman" class="text-lg font-semibold">Tahun Pengalaman</label>
            <input type="number" value="" class="border rounded-lg p-2">
        </div>
        <div class="flex flex-col gap-2">
            <label for="kategori" class="text-lg font-semibold">Status Aktif</label>
            <select name="kategori" id="kategori" class="border rounded-lg p-2">
                <option value="" disabled selected>Pilih Status</option>
                <option value="fitness">Aktif</option>
                <option value="yoga">Non-Aktif</option>
            </select>
        </div>
